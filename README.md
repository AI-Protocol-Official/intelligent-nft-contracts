# AI Protocol Intelligent NFT #
Intelligent NFT (iNFT) represents an enhancement to an existing NFT out there.
...
1. Clone the repository  
    ```git clone git@github.com:AI-Protocol-Official/intelligent-nft-contracts.git```
2. Navigate into the cloned repository  
    ```cd intelligent-nft-contracts```
